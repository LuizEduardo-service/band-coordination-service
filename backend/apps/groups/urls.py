...
from .views import GroupListView, GroupDetailView, MemberListView, MemberDetailView, GroupAvatarUploadView
...
urlpatterns = [
    ...
    path('groups/<slug:slug>/avatar/', GroupAvatarUploadView.as_view(), name='group_avatar_upload'),
